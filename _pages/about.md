...
### *2022.7 - 2023.4* [智源人工智能研究院](https://www.baai.ac.cn/)**
  ...
  - **完成项目1：提出基于分子原型学习的对比学习，用于弱监督分子性质预测** 
    - 时间段：2022.7 - 2023.4
    - 贡献度：90%, 其他10%由付杰老师和合作同学提供 
...
### *2020.8 - 2022.6* [腾讯公司](https://www.tencent.com/) [[实习证明PDF]](/pdf/job_2020_8.pdf) 
  ...
  - **完成项目3：提出语义伪标签的分子预训练，尝试完全不使用标签来进行分子性质预测**
    - 时间段：2021.12 - 2022.6
    - 贡献度：90%, 其他20%由韩昌俞老师和合作同学提供  
    - 现有难题：
    - 提出办法：
    - 结果： 
  - **完成项目2：提出自适应图学习用于自动化的分子性质、药物-靶标相互作用预测**
    - 时间段：2020.12 - 2021.12
    - 贡献度：80%, 其他20%由韩昌俞老师和合作同学提供 
    - 现有难题：
    - 提出办法：
  ...
  - **完成项目1：基于三元消息传递机制的新型图神经网络** [[HTML]]( https://doi.org/10.1093/bib/bbaa266) [[PDF]](/pdf/2021c.pdf)
    - 时间段：2020.8 - 2022.12
    - 贡献度：50%, 其他50%由李鹏勇同学、韩昌俞老师和合作同学提供 
    - 现有难题：
    - 提出办法：
    - 结果： `发表论文TrimNet[3]`
...
### 2018.1 - 020.8 早期科研工作
  - **早期科研项目3：引入块设计网络设计的图网络，进行分子性质预测** [[HTML]](https://doi.org/10.1016/j.cej.2021.128817) [[PDF]](/pdf/2021a.pdf)
    - 时间段：2019.9 - 2020.7（硕士入学第一年）
    - 贡献度：95%, 其他5%由合作同学提供
    - 现有难题：
    - 提出办法：
    - 结果： 写入毕业论文，`发表论文BGNN[2]`
  - **早期科研项目2：基于机器学习的分子ADME/T性质预测网站** 
    - 时间段：2017.5 - 2018.6（本科期间）
    - 贡献度：95%, 其他5%由合作同学提供
    - 现有难题：
    - 提出办法：
    - 结果：优秀本科学位论文
  - **早期科研项目1：基于Bagging集成学习增强的卷积神经网络**
    - 时间段：2016.6 - 2017.5 (本科期间)
    - 贡献度：95%, 其他5%由合作同学提供 
    - 现有难题：
    - 提出办法：
    - 结果： 发表普刊一篇
