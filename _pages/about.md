...
<details>
    <summary><h3>工作5：基于分子原型对比弱监督学习的分子活性预测</h3></summary>
    <ul>
        <li><b>时间段</b>：2024.06</li>
        ...
        <li><b>结果</b>：只需少量的标签数据即可进行对无标签数据进行较为准确的预测。BACE数据集上使用10%标签数据，在剩下90%数据上预测AUC=0.83(另一个数据集HIV为AUC=0.75)。</li>
        <li><b>示意图：</b></li>
...
<details>
    <summary><h3>工作4：基于分子自适应图学习的分子相互作用和性质预测框架</h3></summary>
    <ul>
        <li><b>时间</b>：2022.07</li>
...
<details>
    <summary><h3>工作3：基于三元消息传递网络的分子性质预测算法</h3></summary>
    <ul>
        <li><b>时间</b>：2021.12</li>
...
<details>
    <summary><h3>工作2：基于化学知识和深度学习的单步逆合成预测方法</h3></summary>
    <ul>
        <li><b>时间</b>：2021.09</li>
        <li><b>背景</b>：现有的基于Transformer的逆合成预测方法存在两个主要问题:1)输出多样性不足;2)化学合理性不足。这些问题限制了Transformer方法在实际应用中的潜力。</li>
        <li><b>方法</b>：提出RetroPrime方法,模仿化学家的逆合成策略,将过程分为两个阶段:(1)将目标分子分解为合成子(synthons);(2)通过添加离去基团生成反应物。这两个阶段分别由两个Transformer模型完成。通过"混合匹配"和"标记对齐"策略来提高输出的多样性和化学可行性。</li>
        <li><b>结果</b>：在USPTO-50K数据集上,当反应类型已知和未知时,Top-1准确率分别达到64.8%和51.4%。在大型数据集USPTO-full上的Top-1准确率接近最先进的基于Transformer的方法。同时有效提高了输出的多样性和化学可行性。</li>
        <li><b>示意图：</b></li>
        <img src="pdf/research_project_retroprime.png" width="100%" height="100%"/>
    </ul>
</details>


<details> 
    <summary><h3>工作1：基于块设计图神经网络的分子性质预测算法</h3></summary>
    <ul>
        <li><b>时间</b>：2021.06</li>
...
<details>
    <summary><h3>早期工作1：基于集成机器学习和图神经网络的小分子-靶标亲和力预测</h3></summary>
    <ul>
        <li><b>时间段</b>：2018.09 - 2019.06（本科大四）</li>
