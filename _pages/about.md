...
黎育权目前是兰大在读博士研究生，研究领域为人工智能辅助药物发现(AIDD)。科研上着力于利用AI的预测和生成能力，结合化信和生信工具，解决标签数据匮乏、解释/泛化/鲁棒性匮乏、性能不足等难题，助力药物分子生成、优化及筛选，最终落地到真实临床前药物发现流程。以第一作者身份在Nature Machine Intelligence在内的多个期刊发表论文。谷歌H-index 6，论文总引用186次。获得MCM/ICM数学建模竞赛Meritorious Winner奖、蓝桥杯软件和信息技术专业人才大赛赛区一等奖。曾获唐敖庆化学奖学金、华为奖学金、博士生国家奖学金。
