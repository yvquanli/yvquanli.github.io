...
黎育权目前是兰大在读博士研究生，研究领域为人工智能辅助药物发现(AIDD)。科研上着力于利用AI的学习和生成能力，结合现有计算化学和生物信息学工具，解决数据样本量小、缺乏可解释性/泛化性/鲁棒性、性能不足等难题，最终应用到真实临床前药物发现流程，从广袤的化学空间中快速精准地找到活性和成药性理想的药物分子。以第一作者身份在Nature Machine Intelligence在内的多个期刊发表论文。谷歌H-index 6，论文总引用186次。获得MCM/ICM数学建模竞赛Meritorious Winner奖、蓝桥杯软件和信息技术专业人才大赛赛区一等奖。曾获唐敖庆化学奖学金、华为奖学金、博士生国家奖学金。
