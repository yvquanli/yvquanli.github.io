...
黎育权目前是兰大在读博士研究生，研究领域为人工智能与药物发现的交叉领域。科研上着力于利用AI的学习和生成能力，结合现有计算化学和生物信息学工具，从广袤的化学空间中快速精准地找到活性和成药性理想的药物分子，应用到真实临床前药物发现流程，解决数据样本量小、缺乏可解释性/泛化性/鲁棒性、性能不足等难题。曾以第一作者身份发表Nature子刊论文一篇，总发表论文10篇(其中主要作者身份4篇Top期刊)，谷歌H-index 5，论文总引用160次。获得MCM/ICM数学建模竞赛Meritorious Winner奖、蓝桥杯软件和信息技术专业人才大赛赛区一等奖。曾获唐敖庆化学奖学金、博士生国家奖学金。Brefings in Bioinfomatics审稿人，为中国人工智能学会会员，中国计算机学会会员，中国化学会会员。
...
- ***2019.9 - 今* &emsp;&emsp;兰州大学**，化学化工学院，硕博(专业：化学信息学)
  - 导师为姚小军教授，现任澳门理工大学教授/博导，学术带头人，H-index 60, 发表论文160余篇，引用16000余次，主持完成国自然等基金课题20余项。曾获得唐敖庆化学奖学金、博士生国家奖学金。
- ***2015.9 - 2019.6*  青海大学**，计算机技术与应用系，本科(专业：计算机科学与技术)
  - 导师为杨培老师(校内)和姚小军教授(校外)，获优秀毕业生称号，优秀本科毕业论文。
...
## 2016.6 - 2020.8 早期科研工作
  ...
  - **早期科研项目1：基于集成机器学习/图神经网络的蛋白质-小分子亲和力预测** 
    ...
    - 背景：大二开始刷Ng和莫烦的ML/DL课程、TensorFlow官方教程、浪叫兽的Kaggle机器学习竞赛教程，大四保研时联系了兰大姚小军老师，相见恨晚，当即放弃其他offer跟随姚老师进入AI Science领域科研。当时深度学习亲和力预测DeepDTA/GraphDTA还未发表。
    ...
    - 结果：PDBBind v2016测试集上集成机器学习相关系数RMSE=1.42，R=0.775(超越当时的前沿工作RF::Vina R=0.739，但不及RF::VinaElem R=0.803)。而GNN测试集预测结果评测R=0.6917不及预期。相关工作写入本科毕业论文，获优秀本科学位论文
    - 示意图：
...
- **游戏**：LOL (大乱斗启动器)，War3 RPG (兽人永不为奴！？不好意思走错片场了)，DNF
- **吉他**：传世烧火棍*5 拥有者
- **摄影**
- **乒乓**？或许算吧
